...
%   ylim([-1,1])
    xlim([1,T])
    title('Moderate Agenda, Responsible Media','FontSize',10)
    ...
    plot(magents(3,:)','LineWidth',6,'Color','black')
    plot(magents(3,:)','LineWidth',3,'Color','magenta')
    
    set(gcf,'position',[700,250,400,300])
    set(gcf,'PaperOrientation','landscape');
    %exportgraphics(gcf,'../figures/agendamedia_moderate_responsible.png')
hold off
